...
import ca.mcgill.cs.swevo.ppa.inference.VariableCollector;
...
//			String typeName = vb.type.toString();
//			if (typeName.endsWith("assert")) {
//				ArrayList<String> vars = new ArrayList<String>();
//				vars.add(name.toString());
//				VariableCollector collector = new VariableCollector(vars);
//				ASTNode tmp = name;
//				while (!(tmp instanceof MethodDeclaration)) {
//					tmp = tmp.getParent();
//				}
//				tmp.accept(collector);
//				List<ITypeBinding> types = collector.getTypes();
//				List<SimpleName> names = collector.getNames();
//				int idx = names.indexOf(name);
//				ITypeBinding tb = types.get(idx);
//				LocalDeclaration ld = (LocalDeclaration)node;
//				ld.type.resolvedType = (TypeBinding) tb;
//			}			
//		}
	}
