...
//            typeDeclaration.superclass.traverse(this, scope);
        	push(JavaEntityType.SUPER_CLASS_TYPES, "", -1, -1);
//        	System.out.println(typeDeclaration.superclass.);
            typeDeclaration.superclass.traverse(this, scope);
            pop();
        }
        visitList(JavaEntityType.SUPER_INTERFACE_TYPES, typeDeclaration.superInterfaces);
//        visitList(JavaEntityType.SUPER_CLASS_TYPES, typeDeclaration.superclass);
        return false;
    }
