...
//        for (ImportReference x : ((CompilationUnitDeclaration)leftast)).
        if (leftast instanceof CompilationUnitDeclaration
            ...
            for (int lfti=0;lfti<leftimt.length;lfti++) {
            	...
            	if (x.startsWith(CommonValue.possible_lib_name1)) {
            ...
            for (int lfti=0;lfti<leftimt.length;lfti++) 
            	for (int rti=0;rti<rightimt.length;rti++) {
            		...
            		if (Arrays.equals(one_x[one_x.length-1], one_y[one_y.length-1])) {
            			boolean lab = true;            		
            			if (!x.toString().startsWith(CommonValue.possible_lib_name1) || !y.toString().startsWith(CommonValue.possible_lib_name1)) {
            				continue;
            			}
        ...
        if (leftast instanceof TypeDeclaration
        	...
        	if (x.superclass != null) {
	        	...
	        	if (y.superInterfaces!=null) {
		        	...
		        	String pattern_o = new String();
		        	String pattern_n = new String();
