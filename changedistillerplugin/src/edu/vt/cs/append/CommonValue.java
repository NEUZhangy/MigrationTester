...
public class CommonValue {
	...
	public static String workspace = "/home/shengzhe/Desktop/PLDI2019/api_migration_data_folder/output_and_intermediate_results/";
	public static String dataspace = "/home/shengzhe/Desktop/PLDI2019/api_migration_data_folder/";
	public static String database_path = "113pldi/113android.db";
	...
	public static List<String> dep_output;
	public static List<String> all_dep;
	
	public static String now_ofile;
	public static String now_nfile;

	public static String applyworkspace = "/home/shengzhe/Desktop/PLDI2019/light_weight_apply_tool_test/";
	public static String applyList = "applyList.txt";
	public static String patternList = "patternList.txt";
...
//	}
	...
	public static boolean check_larger(String xx, String yy) {
		...
		if (xxarray.length > yyarray.length) return true;
		return false;
	}
